...
INSTALLED_APPS = [
    ...
    # Cloudinary Storage (vendosur pas staticfiles për të mos bllokuar admin CSS/JS)
    'cloudinary_storage',
    'cloudinary',
...
# WhiteNoise storage për skedarët statikë (Admin CSS / JS)
...
# Config e re e Storages për versione më të reja të Django
STORAGES = {
    "default": {
